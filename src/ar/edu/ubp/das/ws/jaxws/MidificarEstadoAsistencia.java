...
@XmlRootElement(name = "midificarEstadoAsistencia", namespace = "http://ws.das.ubp.edu.ar/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "midificarEstadoAsistencia", namespace = "http://ws.das.ubp.edu.ar/")

public class MidificarEstadoAsistencia {
